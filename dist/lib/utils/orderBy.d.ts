...
import { SortByIterateeFunction, SortByIterateeProperty } from './sortBy';
 ...
 * @returns Array
 */
export default function orderBy<Item extends PlainObject>(source: Item[], iteratee: OrderByIteratee<Item> | string, reversed?: boolean): Item[];
